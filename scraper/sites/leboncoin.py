"""Scraper LeBonCoin — best-effort. Bloqué par DataDome dans la majorité des cas
(403). Conservé pour bascule si l'accès s'ouvre. URLs de recherche dans config.yaml."""
...
RE_LISTING = re.compile(r"leboncoin\.fr/(?:ad/locations/|.*?/)\d{6,}", re.I)
